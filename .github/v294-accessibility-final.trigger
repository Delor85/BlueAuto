run=v2.9.4-accessibility-safe-reconnect-4
...
method=service-registration-150s-real-reboot-framework-ready-system-reconnect-relaunch-process-alive-crash-check
