...
need((gradle.includes('versionCode 58')&&gradle.includes('versionName "2.9.3"'))||((gradle.includes('versionCode 60')||gradle.includes('versionCode 61')||gradle.includes('versionCode 62')||gradle.includes('versionCode 63')||gradle.includes('versionCode 64'))&&(gradle.includes('versionName "2.9.5"')||gradle.includes('versionName "2.9.6"')||gradle.includes('versionName "2.9.7"')||gradle.includes('versionName "2.9.8"')||gradle.includes('versionName "2.9.9"'))),'v2.9.3+ release identity required');
