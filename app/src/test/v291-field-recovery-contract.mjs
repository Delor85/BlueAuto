...
must(gradle.includes('versionCode 56')&&gradle.includes('versionName "2.9.1"'),'v2.9.1/code56 identity missing');
must(api.includes('payload.put("app_version", "2.9.1");'),'v2.9.1 heartbeat telemetry missing');
