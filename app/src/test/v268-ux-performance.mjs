...
for(const roleLabel of ["configuration.role==='DAE'","configuration.role==='DSM'","configuration.role==='POS'","tabLabel('reports','Accueil')","tabLabel('fleet','Réseau')","tabLabel('support','Activité')","tabLabel('config','Gérer')","tabLabel('flux','Piloter')","tabLabel('flux','Fournir')","tabLabel('flux','Vendre')"]){
