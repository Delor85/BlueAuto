...
if(!(worker.includes("2.6.11-cloudflare")||worker.includes("2.8.0-cloudflare")||worker.includes("2.9.0-cloudflare")||worker.includes("2.9.1-cloudflare")||worker.includes("2.9.3-cloudflare")||worker.includes("2.9.5-cloudflare"))||!worker.includes('capabilities: {commissions: true')) throw new Error('worker capabilities missing');
if(!(gradle.includes('versionCode 52')||gradle.includes('versionCode 53')||gradle.includes('versionCode 54')||gradle.includes('versionCode 55')||gradle.includes('versionCode 56')||gradle.includes('versionCode 58')||gradle.includes('versionCode 60'))||!(gradle.includes('versionName \"2.7.1\"')||gradle.includes('versionName \"2.8.0\"')||gradle.includes('versionName \"2.8.1\"')||gradle.includes('versionName \"2.9.0\"')||gradle.includes('versionName \"2.9.1\"')||gradle.includes('versionName "2.9.3"')||gradle.includes('versionName "2.9.5"'))) throw new Error('android version mismatch');
if(!(api.includes('\"2.7.1\"')||api.includes('\"2.8.0\"')||api.includes('\"2.8.1\"')||api.includes('\"2.9.0\"')||(api.includes('\"2.9.1\"')||api.includes('\"2.9.3\"')||api.includes('\"2.9.5\"')))) throw new Error('api client version mismatch');
