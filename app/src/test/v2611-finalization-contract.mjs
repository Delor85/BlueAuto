...
if(!(worker.includes("2.6.11-cloudflare")||worker.includes("2.8.0-cloudflare")||worker.includes("2.9.0-cloudflare"))||!worker.includes('capabilities: {commissions: true')) throw new Error('worker capabilities missing');
