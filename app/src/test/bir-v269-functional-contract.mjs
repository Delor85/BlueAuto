...
if(!(gradle.includes('versionCode 52')||gradle.includes('versionCode 53')||gradle.includes('versionCode 54')||gradle.includes('versionCode 55')||gradle.includes('versionCode 56')||gradle.includes('versionCode 58')||gradle.includes('versionCode 60'))||!(gradle.includes('versionName \"2.7.1\"')||gradle.includes('versionName \"2.8.0\"')||gradle.includes('versionName \"2.8.1\"')||gradle.includes('versionName \"2.9.0\"')||gradle.includes('versionName \"2.9.1\"')||gradle.includes('versionName "2.9.3"')||gradle.includes('versionName "2.9.5"'))) throw new Error('version mismatch');
