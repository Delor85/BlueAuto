...
if(pkg.version!=='2.6.10') throw new Error('Cloudflare package version not 2.6.10');
if(lock.version!=='2.6.10'||(lock.packages&&lock.packages['']&&lock.packages[''].version!=='2.6.10')) throw new Error('Cloudflare lock root version not 2.6.10');
for(const required of ['publish_permanent','authorized_sha','inputs.authorized_sha == github.sha','Préparer une signature éphémère de validation','v268-native-status.mjs','v2610-field-control-tower.mjs','BIR-Blue-Infinity-Retail-v2.6.10-Control-Tower-Release.apk','versionName=2.6.10']){
...
console.log('v2.6.10 release hygiene: metadata aligned, normal CI ephemeral and permanent delivery SHA-gated OK');
