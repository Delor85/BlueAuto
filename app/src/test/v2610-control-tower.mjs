...
if(!worker.includes("source: 'TRANSACTION_OVERRIDE'")||!(worker.includes("const API_VERSION = '2.6.11-cloudflare'")||worker.includes("const API_VERSION = '2.8.0-cloudflare'")||worker.includes("const API_VERSION = '2.9.0-cloudflare'"))) throw new Error('worker one-off commission missing');
