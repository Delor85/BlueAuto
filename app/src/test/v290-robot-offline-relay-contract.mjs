...
must((gradle.includes('versionCode 55')||gradle.includes('versionCode 56')||gradle.includes('versionCode 58')||gradle.includes('versionCode 60'))&&(gradle.includes('versionName "2.9.0"')||gradle.includes('versionName "2.9.1"')||gradle.includes('versionName "2.9.3"')||gradle.includes('versionName "2.9.5"')),'v2.9.x identity missing');
