...
assert.match(gradleConfig, /versionCode (?:51|52|53|54|55|58|60|61|62|63)/);
assert.match(gradleConfig, /versionName "(?:2\.7\.(?:0|1)|2\.8\.(?:0|1)|2\.9\.0|2\.9\.3|2.9.5|2.9.6|2.9.7|2.9.8)"/);
