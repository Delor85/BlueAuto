(function(){
'use strict';
/* v2.9.9.2 compatibility loader: Transaction-First -> Reference-Stability -> Field-Runtime -> Completion.
 * This loader does not create a second assistant or polling loop.
 * It never bypasses historical finance/USSD guards. */
function id(x){return document.getElementById(x);}
function loadV2992(){if(id('birV2992Script'))return;var css=document.createElement('link');css.rel='stylesheet';css.href='field-runtime-v2992.css';css.id='birV2992Css';document.head.appendChild(css);var s=document.createElement('script');s.id='birV2992Script';s.src='field-runtime-v2992.js';s.async=false;document.body.appendChild(s);}
function loadV2991(){if(id('birV2991Script')){loadV2992();return;}var css=document.createElement('link');css.rel='stylesheet';css.href='field-runtime-v2991.css';css.id='birV2991Css';document.head.appendChild(css);var s=document.createElement('script');s.id='birV2991Script';s.src='field-runtime-v2991.js';s.async=false;s.onload=loadV2992;document.body.appendChild(s);}
