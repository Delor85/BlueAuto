 ...
 * -> v2.9.9.5 convergence -> v2.9.9.6 AI discovery/guide + role guard + privileged MOCK/ADMIN guide.
 ...
 * The role guard prevents PoS from receiving DAE/DSM-only Assistant guidance. The privileged
 * guide restores MOCK Mercenaires and ADMIN/SUPER-ADMIN documentation without turning them into SIM roles.
...
function loadPrivileged(){addScriptOnce('birV2996PrivilegedGuide','privileged-guide-v2996.js');}
function loadRoleGuard(){addScriptOnce('birV2996AiRoleGuard','ai-role-guard-v2996.js',function(){window.setTimeout(loadPrivileged,40);});}
