...
final class ApiClient {
    ...
    JSONObject platformAction(String action, JSONObject payload) throws Exception {
        ...
        if (!safe.matches("(?:operator_insights|operator_catalog|platform_snapshot|network_balance_audit|shadow_enroll|debt_save|debt_list|kyc_save|mercenary_save|mercenary_list|mercenary_sale|commission_policy|commission_set_default|commission_set_child|accounting_summary|transaction_ledger|ops_cockpit|ops_escalate|ops_resolve|owner_ops_cockpit|owner_ops_resolve|owner_snapshot|owner_transactions|owner_audit|owner_control|owner_assist|owner_tchoronko_save)")) {
